...
//            },
            ...
            },
            {
                ...
                cpu: {
                    ...
                    max: 24,
                    step: false,
                    steps: [1, 2, 4, 6, 8, 10, 12, 16, 20, 24],
                    pricePerOne: 120,
                    coef: 1.05
                },
                ram: {
    ...
    init: function () {
        ...
        this.objects.ssdCB.prop('checked', this.data.ssdCheck);
        this.objects.ssd = $('#ssd-space');
        this.objects.ssdText = $('#ssd-space-text');
        this.objects.hddCB = $('#hdd');
        this.objects.hddCB.prop('checked', this.data.hddCheck);
    ...
    selectServer: function () {
        ...
        this.objects.cpu.off('slide').on('slide', $.proxy(function (event, ui) {
            ...
            this.objects.cpuText.text(this.texts.cpu + this.data.cpu);
            this.doCalc();
        }, this));
        this.objects.cpuText.text(this.texts.cpu + this.data.cpu);
