    ...
    <body>
        <div class="container-fluid h100 main">
            <div class="row h100">
                ...
                <div class="col-xs-12 col-sm-6 item" data-block="service-2">
                    <div class="as-table">
                        <div class="cell-middle">
                ...
                <div class="col-xs-12 col-sm-6 item" data-block="service-3">
                    <div class="as-table">
                        <div class="cell-middle">
                ...
                <div class="col-xs-12 col-sm-6 item" data-block="service-4">
                    <div class="as-table">
                        <div class="cell-middle">
                            Web-Хостинг
                        </div>
        ...
        <div class="container-fluid service" style="display: none" id="service-2">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <h2>Сервер терминалов (удаленных рабочих столов)</h2>
                        <p>
                            Периодически у бизнеса возникает задача организации доступа сотрудников к их рабочему месту не только из офиса. К примеру: сотрудник организации уезжает в командировку и ему необходимо по служебной необходимости осуществить вход на свой рабочий компьютер. Кроме того, перед бизнесом часто возникает задача экономии ресурсов на модернизацию своей IT-инфраструктуры, в частности тех персональных компьютеров, с которыми работают сотрудники компании. Некоторые компании предпочитают использование услуг удаленных сотрудников (Outsourcing), перед ними так же возникает задача организации рабочего места для таких сотрудников.
                        </p>
                        <p>
        ...
        <? // </editor-fold> ?>
        <? // <editor-fold defaultstate="collapsed" desc="Cloud"> ?>
        <div class="container-fluid service" style="display: none" id="service-3">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <h2>Облачная рабочая станция</h2>
                        <p>
                        </p>
                        <p>
                        </p>
        ...
        <div class="container-fluid service" style="display: none" id="service-4">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <h2>Web-Хостинг</h2>
