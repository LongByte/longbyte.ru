<?$RIGHTS = $GLOBALS["APPLICATION"]->GetGroupRight("edvance.photogallery");
if ($RIGHTS > "D"):
	...
	$arSights = @unserialize(COption::GetOptionString("edvance.photogallery", "pictures"));
	...
	if($REQUEST_METHOD == "POST" && ($save!="" || $apply!="") && ($RIGHTS>="W") && check_bitrix_sessid())
	{
		...
		COption::SetOptionString("edvance.photogallery", "pictures", serialize($arSights));
...
?>
<a href="/bitrix/admin/fileman_file_upload.php?path=/bitrix/modules/edvance.photogallery/fonts/"><?=GetMessage("P_UPLOAD")?></a>
</td></tr>
...
<?=str_replace(
	array(
		...
		"#FILEMAN_FILE_UPLOAD#"),
	array(
		"/bitrix/admin/fileman_admin.php?site=&path=/bitrix/modules/edvance.photogallery/fonts/",
		"/bitrix/admin/fileman_file_upload.php?path=/bitrix/modules/edvance.photogallery/fonts/"),
