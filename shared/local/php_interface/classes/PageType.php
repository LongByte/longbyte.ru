...
class PageType {
    ...
    function GetUserTypeDescription() {
        return array(
            ...
            "PrepareSettings" => Array("PageType", "PrepareSettings"),
            "GetSettingsHTML" => Array("PageType", "GetSettingsHTML"),
            "GetPropertyFieldHtml" => Array("PageType", "GetPropertyFieldHtml"),
            "GetAdminListViewHTML" => Array("PageType", "GetAdminListViewHTML"),
            "ConvertToDB" => Array("PageType", "ConvertToDB"),
            "ConvertFromDB" => Array("PageType", "ConvertFromDB"),
        );
    }
