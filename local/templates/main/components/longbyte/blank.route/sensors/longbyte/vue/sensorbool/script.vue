<template id="sensorbool">
    <div :class="getSensorboolClass()">
        ...
        <div class="sensorbool__value" v-if="sensor.values.length > 0">
            <div class="sensorbool__value-avg" v-if="getLastValue()">Current:
                <span class="sensorbool__value-current-value" v-html="getLastValue()"></span>
            </div>
            <div class="sensorbool__value-avg">Avg:
                <span class="sensorbool__value-avg-value" v-html="getAvgValue()"></span>
            </div>
            <div class="sensorbool__value-min">Min:
                <span class="sensorbool__value-min-value" v-html="getMinValue()"></span>
            </div>
            <div class="sensorbool__value-max">Max:
                <span class="sensorbool__value-max-value" v-html="getMaxValue()"></span>
            </div>
        </div>
    </div>
</template>
