...
$MESS['OP_CS_FILES_MASK'] = 'Список имен файлов для рекурсивного поиска';
$MESS['OP_CS_COMPILER'] = 'Препроцессор (SASS/Less0';
...
$MESS['OP_CS_TMP_FILE_MASK'] = 'Маска временного файла для записи css файла. (%s обязателен, он заменится на таймштамп файла)';
