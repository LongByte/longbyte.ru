...
//--------------------
    ...
    $scenarios && $form->sButtonsContent .= '<input type="submit" class="adm-btn-save" name="apply" value="' . $localization->getDataByPath('btnApply') . '" title="' . $localization->getDataByPath('btnApply') . '"/>';
    $lastSetupLog && $form->sButtonsContent .= '<input type="submit" name="rollback" value="' . $localization->getDataByPath('btnRollback') . '" title="' . $localization->getDataByPath('btnRollback') . '"/>';
    $form->Show();
    ?></form>
<?php
